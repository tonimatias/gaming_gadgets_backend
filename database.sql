...
insert into popular_product (name, price, old_price, description, category_id, image) values ('Steelseries Rival 3', 39.90, null, 'Sopii oikeakätisille pelaajille. 16,8 miljoonan värin RGB valaistus. 60 miljoonan klikkauksen kytkimet', 1, 'steelseries_rival3.jpeg');